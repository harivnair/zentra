    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
            <div className="max-w-xl text-center">
                ...
                <h1 className="text-2xl font-bold mb-2">Schedules — Coming Soon</h1>
                <p className="text-muted-foreground mb-6">We&apos;re working on the Schedules section. Check back soon.</p>
