                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            You have {vendorCount} {vendorCount === 1 ? 'Vendor' : 'Vendors'} registered
                        </p>
                    </div>
                </div>
                ...
                <div className="rounded-lg bg-white p-4 sm:p-6 shadow-sm">
                    ...
                    <div className="flex flex-col gap-4 md:hidden">
                        ...
                        {!loading && !error && vendors.length === 0 && (
                            <div className="p-4 text-muted-foreground">No vendors found. Add your first vendor to get started.</div>
                        )}
                        ...
                        {!loading && !error && vendors.map((vendor) => (
                            <div key={vendor.id} className="border rounded-md p-4">
                                ...
                                <div className="mt-2 text-sm text-muted-foreground">{vendor.phone}</div>
                                <div className="mt-1 text-sm text-muted-foreground truncate">{vendor.billingAddress}</div>
                                <div className="mt-3 flex gap-4 text-sm">
                                    <span>GST: <span className="font-medium">{vendor.gst}%</span></span>
                                    <span>TDS: <span className="font-medium">{vendor.tds}%</span></span>
                                </div>
                            ...
                            <tbody>
                                ...
                                {!loading && !error && vendors.map((vendor) => (
                                    <tr key={vendor.id} className="border-t hover:bg-gray-50">
                                        ...
                                        <td className="py-4 max-w-xs truncate" title={vendor.billingAddress}>
